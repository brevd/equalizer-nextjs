...
import { TAddOptimistic } from "@/app/(app)/admin/bill-mates-to-groups/useOptimisticBillMatesToGroups";
...
export default function OptimisticBillMatesToGroup({
  ...
  const [optimisticBillMatesToGroup, setOptimisticBillMatesToGroup] =
    useOptimistic(billMatesToGroup);
    ...
    <div className="m-4">
      ...
      <div className="flex justify-between items-end mb-4">
        <h1 className="font-semibold text-2xl">
          {optimisticBillMatesToGroup.billGroupId}
        </h1>
